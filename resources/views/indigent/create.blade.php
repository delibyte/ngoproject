<x-layout>
    <x-setting :heading="'Apply For Indigentship'" class="w-10/12 mx-auto">
        <form id="indigentForm" method="POST" action="{{ route('indigent.application.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <x-form.input name="expenditure" type="number" :value="old('expenditure')" required />
