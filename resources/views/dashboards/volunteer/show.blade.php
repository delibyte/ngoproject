<x-layout>
    <div class="w-7/12 mx-auto -mb-28">
        <x-setting :heading="'Shipment Information'">
            <form method="POST" action="{{ route('volunteer.dashboard.shipment.update', $shipment->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <x-form.input name="location" :value="$shipment->receiver->user->address" disabled />
